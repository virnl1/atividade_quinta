...
class PassGen:
    ...
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('Quantidade de caracteres'),
             sg.Combo(values = list(range(1, 31)), key='total_chars', default_value=8, size=(3,1))],
            [sg.Output(size=(32,5))],
    ...
    def Iniciar(self):
        while True:
            ...
            if evento == 'Gerar Senha':
                ...
                print(nova_senha)
                self.salvar_senha(valores, nova_senha)
    ...
    def salvar_senha(self, valores, nova_senha):
...
# Criação e execução da classe FORA da definição
gen = PassGen()
gen.Iniciar()